...
char *Sha256_auth(const unsigned char *data)
{
	// test data
//	BYTE text1[] = {"BF39E9B3F6CF38EDFBD447BC812E8D7BF33AD308DCD8536908C27710EBB817462025.01.07/20:39.24FE8CFF4E0893EC5D4B27793300E7D835493E586A02C5C8F70524B97A7B4B4170"};
//	BYTE text2[] = {"halloworld"};
	...
	SHA256_CTX ctx;
		...
		sha256_init(&ctx);
		sha256_update(&ctx, (BYTE *)data, strlen((const char*)data));
		sha256_final(&ctx, buf);
		char strbuf[65] = {0};
		ByteToString(buf,strbuf,32);
